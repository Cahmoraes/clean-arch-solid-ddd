...
- [x] 5. GoogleAuthProvider — abstração e implementações [RF-003, RF-004] → `task-05.md`
- [x] 6. AuthenticateWithGoogleUseCase [RF-001, RF-002, RF-007, RF-008, RF-009, RF-010] → `task-06.md`
- [x] 7. Controller + Rotas + IoC + Business Flow Tests [RF-001, RF-002, RF-003, RF-004, RF-005, RF-006, RF-015] → `task-07.md`
- [x] 8. Integração Frontend — Botão "Entrar com Google" [US-001, US-002, US-003, US-004] → `task-08.md`
