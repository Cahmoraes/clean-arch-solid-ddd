...
- [x] 9. `GymImageController` + rota `POST /gyms/:gymId/image` + wiring + business-flow [FR-005, FR-007, FR-015] → `task-09.md`
- [x] 10. Regenerar tipos OpenAPI + validar dependency-cruiser [FR-006, FR-013] → `task-10.md`
