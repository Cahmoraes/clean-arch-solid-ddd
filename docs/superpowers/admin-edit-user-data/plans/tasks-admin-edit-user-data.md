...
- [x] 1. Policy de domínio `UserManagementPolicy` + erro de autorização [FR-005, FR-006, FR-007, FR-008, FR-009, FR-010] → `task-01.md`
...
- [x] 5. Expor `isSuperAdmin` no JWT e na resposta de GET /users [FR-002, FR-007] → `task-05.md`
