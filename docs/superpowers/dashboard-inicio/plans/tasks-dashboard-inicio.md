...
- [ ] 1. Refatorar AuthenticatedShell → AppSidebar [RF-004, RF-005, RF-006, RF-007, RF-008] → `task-01.md`
- [ ] 2. Criar rota `/inicio` e atualizar redirect pós-login [RF-001, RF-002, RF-003] → `task-02.md`
- [ ] 3. Dashboard API hook + funções de cálculo de métricas [RF-014, RF-015, RF-016, RF-018, RF-019, RF-026, RF-027] → `task-03.md`
- [ ] 4. ProfileHeroCard + KpiCards [RF-009, RF-010, RF-011, RF-012, RF-013] → `task-04.md`
- [ ] 5. WeeklyChart + HeatmapCard [RF-015, RF-016, RF-017, RF-018, RF-019, RF-020, RF-021] → `task-05.md`
- [ ] 6. CheckinsTimeline + StatusDonutCard [RF-022, RF-023, RF-024, RF-025, RF-026, RF-027, RF-028] → `task-06.md`
- [ ] 7. DashboardPage — composição, estados de erro/vazio e validação final [RF-029, RF-030, RF-031] → `task-07.md`
