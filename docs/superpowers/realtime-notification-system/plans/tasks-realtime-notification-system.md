...
- [x] 1. CheckInApprovedEvent + events.ts update [RF-020, RF-021] → `task-01.md`
- [x] 2. Notification entity + domain errors [RF-020, RF-021, RF-022, RF-023] → `task-02.md`
- [x] 3. NotificationRepository interface [RF-024, RF-025, RF-026, RF-027] → `task-03.md`
- [x] 4. InMemory notification repository [RF-024, RF-025, RF-026] → `task-04.md`
- [x] 5. Get notifications + unread count use cases [RF-025, RF-026] → `task-05.md`
- [x] 6. Mark as read use cases [RF-016, RF-017, RF-018, RF-019] → `task-06.md`
