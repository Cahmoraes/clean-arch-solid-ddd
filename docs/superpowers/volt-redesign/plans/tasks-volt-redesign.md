...
- [x] 5. ThemeToggle deslizante (substitui o FAB) [RF-002] → `task-05.md`
- [x] 6. Redesign do shell autenticado (sidebar dark + topbar + responsivo) [RF-011, RF-012, RF-013, RF-022] → `task-06.md`
- [x] 7. Redesign do shell público + tela de Login [RF-014, RF-015, RF-023] → `task-07.md`
- [x] 8. Redesign do Dashboard (stat-grid, week-chart, rank-list, atividade) [RF-016, RF-024] → `task-08.md`
- [x] 9. Redesign Admin Usuários (page-header, segmented, search, user-row) [RF-017] → `task-09.md`
- [x] 10. Redesign Admin Check-ins (segmented, checkin-row, ações inline) [RF-018] → `task-10.md`
- [x] 11. Redesign Perfil (profile-card, metric-card, streak) [RF-019] → `task-11.md`
- [x] 12. Redesign Assinatura (billing-banner, plan-grid) [RF-020] → `task-12.md`
- [x] 13. Redesign Academias (gym-grid, gym-card) [RF-021, RF-024] → `task-13.md`
- [x] 14. Polimento global: movimento, acessibilidade, responsividade e gate final [RF-025, RF-026, RF-027, RF-028] → `task-14.md`
