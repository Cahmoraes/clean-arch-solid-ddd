export interface paths {
    ...
    "/api/v1/notifications/{id}": {
        ...
        /**
         * Delete notification
         * @description Soft-deletes a notification of the authenticated user. Responds 404 when it does not exist, belongs to another user or was already deleted.
         */
        delete: {
            parameters: {
                query?: never;
    ...
    "/weather": {
         ...
         * @description Public endpoint: resolves a city name to coordinates and returns the current temperature plus the day's min/max.
         */
        get: {
            parameters: {
                query: {
