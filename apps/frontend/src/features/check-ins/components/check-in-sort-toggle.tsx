...
export function CheckInSortToggle({
	...
	return (
		<button
			type="button"
			onClick={handleClick}
			className="inline-flex h-[52px] w-[160px] shrink-0 items-center justify-center gap-2 rounded-md border border-border bg-surface px-4 text-sm text-foreground transition-colors hover:bg-surface/80"
		>
			{isDesc ? (
