		...
		>
			...
			<div className="flex flex-1 flex-col gap-2.5 p-[18px]">
				<div
					...
					className="h-4 w-3/4 rounded-xs shimmer"
				/>
				<div className="h-3 w-1/2 rounded-xs shimmer" />
				<div className="mt-2 h-3 w-full rounded-xs shimmer" />
				<div className="mt-auto flex items-center justify-between border-t border-border pt-3.5">
					<div className="h-3 w-1/4 rounded-xs shimmer" />
					<div className="h-7 w-20 rounded-xs shimmer" />
				</div>
			</div>
		</div>
	)
