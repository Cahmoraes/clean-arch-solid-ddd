...
> = {
	where?: Prisma.GymWhereInput
	orderBy?:
		| Prisma.GymOrderByWithAggregationInput
		| Prisma.GymOrderByWithAggregationInput[]
...
export type GetGymGroupByPayload<T extends GymGroupByArgs> =
...
export type GymWhereInput = {
	...
	cnpj?: Prisma.StringFilter<"Gym"> | string
...
export type GymScalarWhereWithAggregatesInput = {
	AND?:
		| Prisma.GymScalarWhereWithAggregatesInput
		| Prisma.GymScalarWhereWithAggregatesInput[]
	...
	cnpj?: Prisma.StringWithAggregatesFilter<"Gym"> | string
...
export type GymGetPayload<
	S extends boolean | null | undefined | GymDefaultArgs,
...
> {
	[K: symbol]: {
		types: Prisma.TypeMap<ExtArgs>["model"]["Gym"]
		meta: { name: "Gym" }
	}
	/**
	...
	>(
		args: Prisma.SubsetIntersection<T, GymGroupByArgs, OrderByArg> &
			InputErrors,
	): {} extends InputErrors
		? GetGymGroupByPayload<T>
...
export interface GymFieldRefs {
	...
	readonly cnpj: Prisma.FieldRef<"Gym", "String">
...
> = {
	 ...
	 */
	data: Prisma.XOR<
		Prisma.GymUpdateManyMutationInput,
		Prisma.GymUncheckedUpdateManyInput
	>
	/**
