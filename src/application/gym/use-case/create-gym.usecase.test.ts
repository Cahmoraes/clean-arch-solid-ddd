import { InvalidLatitudeError } from '@/domain/check-in/error/invalid-latitude-error'
import { InvalidLongitudeError } from '@/domain/check-in/error/invalid-longitude-error'
