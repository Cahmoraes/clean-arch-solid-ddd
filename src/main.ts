...
import type { SQLiteConnection } from "./shared/infra/database/connection/sqlite-connection"
...
const sqliteConnector = container.get<SQLiteConnection>(
	SHARED_TYPES.SQLite.Client,
)

console.log(sqliteConnector)
